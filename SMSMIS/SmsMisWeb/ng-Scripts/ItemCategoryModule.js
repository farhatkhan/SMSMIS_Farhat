(function () {
    ...
    var comController = function ($scope, $http) {
        ...
        $scope.onCompanyChange = function () {
            ...
            $http.post("/UI/getAllItemCategoryCompany", { CompanyCode: $scope.selectedObject.CompanyCode }).then(onListComplete, onRequestError);
        }
        ...
        var isValid = function () {
            ...
            else if (isnullorEmpty($scope.selectedObject.CategoryName))
                return false;//$scope.listError = "Category Name is Required";
        ...
        $scope.save = function () {
            ...
            $http.post("/UI/saveItemCategory", { ItemCategory: $scope.selectedObject, companyId: $scope.selectedObject.CompanyCode }).then(onSaveComplete, onRequestError);//saif
        }
        ...
        $scope.delete = function () {
            ...
            if (confirm('Are you sure you want to delete this record?')) {
                showDeleteShield();
                $http.post("/UI/deleteItemCategory", $scope.selectedObject).then(onDelete, onRequestError)
            }
        }
    ...
    app.controller("ItemCategoryController", comController);
}
)();