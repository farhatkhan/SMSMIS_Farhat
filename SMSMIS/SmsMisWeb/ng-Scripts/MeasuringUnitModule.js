(function () {
    ...
    var comController = function ($scope, $http) {
        ...
        $scope.onCompanyChange = function () {
            ...
            $http.post("/UI/getAllMeasuringUnitCompany", { CompanyCode: $scope.selectedObject.CompanyCode }).then(onListComplete, onRequestError);
        }
        ...
        var isValid = function () {
            ...
            else if (isnullorEmpty($scope.selectedObject.UnitName))
                return false;//$scope.listError = "Unit Name is Required";
        ...
        $scope.save = function () {
            ...
            $http.post("/UI/saveMeasuringUnit", { MeasuringUnit: $scope.selectedObject, companyId: $scope.selectedObject.CompanyCode }).then(onSaveComplete, onRequestError);//saif
        }
        ...
        $scope.delete = function () {
            ...
            if (confirm('Are you sure you want to delete this record?')) {
                showDeleteShield();
                $http.post("/UI/deleteMeasuringUnit", $scope.selectedObject).then(onDelete, onRequestError)
            }
        }
    ...
    app.controller("MeasuringUnitController", comController);
}
)();