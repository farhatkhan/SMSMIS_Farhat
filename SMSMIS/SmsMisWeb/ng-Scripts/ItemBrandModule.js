(function () {
    ...
    var comController = function ($scope, $http) {
        ...
        $scope.onCompanyChange = function () {
            ...
            $http.post("/UI/getAllItemBrandCompany", { CompanyCode: $scope.selectedObject.CompanyCode }).then(onListComplete, onRequestError);
        }
        ...
        var isValid = function () {
            ...
            else if (isnullorEmpty($scope.selectedObject.BrandName))
                return false;//$scope.listError = "Brand Name is Required";
        ...
        $scope.save = function () {
            ...
            $http.post("/UI/saveItemBrand", { ItemBrand: $scope.selectedObject, companyId: $scope.selectedObject.CompanyCode }).then(onSaveComplete, onRequestError);//saif
        }
        ...
        $scope.delete = function () {
            ...
            if (confirm('Are you sure you want to delete this record?')) {
                showDeleteShield();
                $http.post("/UI/deleteItemBrand", $scope.selectedObject).then(onDelete, onRequestError)
            }
        }
    ...
    app.controller("ItemBrandController", comController);
}
)();