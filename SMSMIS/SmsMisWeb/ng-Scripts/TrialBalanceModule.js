(function () {
    ...
    var comController = function ($scope, $http, $filter) {
        ...
        $scope.openreport = function () {
            ...
            window.location = "/Report/Report?CompanyCode=" + $scope.selectedObject.CompanyCode + "&ReportID=108&BranchCodes=" + arrbranch.toString() + "&VoucherType=" + arrVType.toString() + "&FromDate=" + fromDate + "&ToDate=" + toDate + "&FromVoucher=" + frmvoucher + "&ToVoucher=" + tovoucher;
        ...
        var isFormLoaded = function () {
            if (GetAllBranch && GetCompany && GetVoucher) {
                hideShield();
            }
        }
    ...
    app.controller("PVController", comController);
    addDirectives(app);
}
)();