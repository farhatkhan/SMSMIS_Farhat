(function () {
    ...
    var comController = function ($scope, $http) {
        ...
        $scope.onCompanyChange = function () {
            ...
            $http.post("/UI/getAllItemGradeCompany", { CompanyCode: $scope.selectedObject.CompanyCode }).then(onListComplete, onRequestError);
        }
        ...
        var isValid = function () {
            ...
            else if (isnullorEmpty($scope.selectedObject.GradeName))
                return false;//$scope.listError = "Grade Name is Required";
        ...
        $scope.save = function () {
            ...
            $http.post("/UI/saveItemGrade", { ItemGrade: $scope.selectedObject, companyId: $scope.selectedObject.CompanyCode }).then(onSaveComplete, onRequestError);//saif
        }
        ...
        $scope.delete = function () {
            ...
            if (confirm('Are you sure you want to delete this record?')) {
                showDeleteShield();
                $http.post("/UI/deleteItemGrade", $scope.selectedObject).then(onDelete, onRequestError)
            }
        }
    ...
    app.controller("ItemGradeController", comController);
}
)();